...
The little face in the corner is an SVG drawn by hand for this site, paths, gradients and an SVG pattern for the plaid. He blinks using the animate tag, tilts on hover, and shows up in the nav, the contact section, the resume and the 404 page, where he is having a worse day.

Live at [saumilcodes.github.io](https://saumilcodes.github.io)

## Running it locally

No build step. Clone it and open `index.html` in a browser, that's it.
